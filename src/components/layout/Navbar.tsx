...
export function Navbar() {
  ...
  return (
    ...
    >
          ...
          {items.map((item) => {
            ...
            return (
              ...
              >
                <button
                  type="button"
                  className="inline-flex items-center gap-1.5 rounded-full px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-100 hover:text-slate-900 dark:text-slate-200 dark:hover:bg-slate-800 dark:hover:text-white"
                  aria-haspopup="menu"
                  aria-expanded={open}
      ...
      {mobileOpen ? (
        <div className="border-t border-slate-200 bg-white/90 backdrop-blur md:hidden dark:border-slate-700 dark:bg-slate-900/90">
