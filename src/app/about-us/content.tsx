...
export const mission = [
    "To simplify loan and insurance processes for working professionals",
    "To provide quick, hassle-free financial assistance",
    "To ensure transparency and trust in every transaction",
