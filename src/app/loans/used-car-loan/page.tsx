...
import usedCarLoanHeroImage from "@/assets/loans/ucl-1.png";
import usedCarLoanApplyImage from "@/assets/loans/ucl-3.png";
import usedCarLoanChargesImage from "@/assets/loans/ucl-2.png";
import { useAuth } from "@/lib/useAuth";
import { TrustedCustomersStats } from "../../../components/loan/TrustedCustomersStats";

const featureCards = [
  { id: "01", title: "Easy used car financing", desc: "Simple quotation-based assessment helps evaluate your car purchase value." },
...
const chargeRows = [
  ["Interest Rate", "Starting from 8.5% to 15% per annum"],
...
const loanTypes = [
  ["Pre-owned Sedan", "Finance your preferred sedan with easy EMIs and flexible terms."],
  ["Pre-owned SUV", "Purchase a reliable SUV with structured financing support."],
  ["Pre-owned Hatchback", "Affordable pre-owned hatchback financing for daily commute."],
  ["Pre-owned Luxury Vehicles", "Finance luxury vehicles with premium lender options."],
  ["Pre-owned Commercial Vehicles", "Support commercial vehicle financing for business use."],
];
...
export default function UsedCarLoanPage() {
  ...
  const applyHref = signedIn ? "/loans/used-car-loan/apply" : "/sign-in?next=/loans/used-car-loan/apply";
      ...
      <div className="flex w-full flex-col gap-8">
          ...
          <div className="relative grid items-center gap-8 lg:grid-cols-[1.1fr_0.9fr]">
            <div className="space-y-6">
              ...
              <h1 className="text-xl font-bold leading-tight text-slate-900 md:text-3xl">
                Finance your dream pre-owned vehicle with easy EMIs and structured eligibility.
              </h1>
            ...
            <div className="overflow-hidden rounded-4xl border border-slate-200 bg-white shadow-[0_30px_80px_-40px_rgba(15,23,42,0.4)]">
              <Image
                src={usedCarLoanHeroImage}
                alt="Used car loan overview"
        ...
        <section className="w-full bg-slate-100 px-4 py-12 md:px-10 lg:px-16 xl:px-24">
          <h2 className="text-center text-lg font-bold leading-tight text-slate-900 md:text-2xl">
            Online Used Car Loan <span className="text-cyan-600">Features and Benefits</span>
          </h2>
          <p className="mx-auto mt-3 max-w-4xl text-center text-sm leading-relaxed text-slate-800 md:text-base">
            Pre-owned vehicle financing made easy with flexible repayment and structured eligibility.
          </p>
          ...
          <div className="grid items-start gap-8 lg:grid-cols-[1fr_0.9fr]">
            <div>
              <h2 className="text-lg font-bold text-slate-900 md:text-2xl">
                How to Apply for <span className="text-cyan-600">Used Car Loan Easy Approval?</span>
              </h2>
            ...
            <div className="flex items-center justify-center">
              <div className="mx-auto w-full max-w-2xl overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-[0_20px_60px_-35px_rgba(2,132,199,0.45)]">
                <Image
                  src={usedCarLoanApplyImage}
                  alt="Used car loan application process"
        ...
        <section className="w-full bg-slate-50 px-4 py-10 md:px-10 lg:px-16 xl:px-24">
          <h2 className="text-center text-lg font-bold leading-tight text-slate-900 md:text-2xl">
            Used Car Loan <span className="text-sky-700">Eligibility and Documents</span>
          </h2>
          <p className="mx-auto mt-3 max-w-4xl text-center text-sm leading-relaxed text-slate-800 md:text-base">
          ...
          <div className="grid items-center gap-8 rounded-3xl border border-slate-200 bg-[linear-gradient(90deg,#ffffff_0%,#eef2ff_100%)] p-6 shadow-[0_20px_55px_-35px_rgba(15,23,42,0.45)] lg:grid-cols-[1.15fr_0.85fr] md:p-8">
            <div>
              <h2 className="text-lg font-bold leading-tight text-slate-900 md:text-2xl">
                Used Car Loan <span className="text-sky-700">Interest Rate and Applicable Charges</span>
              </h2>
              <p className="mt-3 text-sm leading-relaxed text-slate-800 md:text-base">
            ...
            <div className="mx-auto w-full max-w-md overflow-hidden rounded-3xl">
              <Image
                src={usedCarLoanChargesImage}
                alt="Used car loan rate and charges"
        ...
        <section className="w-full bg-slate-100 px-4 pb-10 pt-4 md:px-10 lg:px-16 xl:px-24">
          <h2 className="text-center text-lg font-bold leading-tight text-slate-900 md:text-2xl">
            Types of <span className="text-cyan-600">Used Car Loan</span>
          </h2>
          <p className="mx-auto mt-3 max-w-4xl text-center text-sm leading-relaxed text-slate-800 md:text-base">
