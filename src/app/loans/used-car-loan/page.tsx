...
export default function UsedCarLoanPage() {
	...
	const applyHref = signedIn ? "/dashboard" : "/sign-in?next=/loans/used-car-loan/apply";
			...
			<div className="flex w-full flex-col gap-8">
				<section className="w-full px-40 py-10 md:px-10 lg:px-16">
					<div className="w-full">
						<h1 className="text-xl font-bold text-slate-900 md:text-3xl">Used Car Loan</h1>
						<p className="mt-4 w-full text-sm leading-relaxed text-slate-900 md:text-lg">
							Used Car Loan helps you finance a pre-owned vehicle with structured eligibility, quotation-based assessment,
							and guided document support from Capital Care.
						</p>
						<p className="mt-3 w-full text-sm leading-relaxed text-slate-700 md:text-base">
							...
							Once submitted, our loan team reviews your profile, vehicle, and quotation details and helps you move ahead.
						</p>

						<div className="mt-5">
							<Link
								href="/loans/used-car-loan/apply"
				...
				<section className="w-full bg-linear-to-br from-white via-sky-50 to-cyan-50 px-4 py-10 md:px-10 lg:px-16">
					<h2 className="text-center text-xl font-bold text-slate-900 md:text-2xl">Used Car Loan Features and Benefits</h2>
				...
				<section className="w-full px-4 md:px-10 lg:px-16">
					<h2 className="text-lg font-bold text-slate-900 md:text-2xl">What are the Eligibility Criteria for Used Car Loan?</h2>
				...
				<section className="w-full px-4 md:px-10 lg:px-16">
					<h2 className="text-lg font-bold text-slate-900 md:text-2xl">What Documents are Required for Used Car Loan?</h2>
					<ul className="mt-4 list-disc space-y-2 pl-6 text-sm text-slate-800 md:text-base">
						{documents.map((item) => (
							<li key={item}>{item}</li>
						))}
				...
				<section className="w-full px-4 md:px-10 lg:px-16">
					<h2 className="text-lg font-bold text-slate-900 md:text-2xl">How to Apply for Used Car Loan?</h2>
					<div className="mt-5 grid gap-6 lg:grid-cols-[1fr_0.4fr]">
						...
						<div className="mt-6 rounded-2xl border border-sky-200 bg-sky-50 p-4 text-sm text-slate-700 md:text-base">
							Submit details with your quotation and vehicle documents; our team coordinates lender-side next steps.
					</div>
				...
				<section className="w-full px-4 md:px-10 lg:px-16">
					<h2 className="text-lg font-bold text-slate-900 md:text-2xl">Used Car Loan Interest Rate and Applicable Charges</h2>
				...
				<section className="w-full px-4 pb-10 md:px-10 lg:px-16">
					<h2 className="text-center text-lg font-bold text-slate-900 md:text-2xl">Types of Used Car Loan</h2>
