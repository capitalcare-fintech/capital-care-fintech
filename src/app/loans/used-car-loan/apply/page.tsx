...
export default function UsedCarLoanApplyPage() {
  ...
  const handleSubmitApplication = async () => {
    ...
    try {
      ...
      payload.append("loanType", "used-car-loan");
      ...
      console.error("[used-car-loan/apply] submit error", submitError);
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm md:p-8">
          <div className="mb-8 space-y-2">
            <h1 className="text-xl font-bold tracking-tight text-slate-900 md:text-2xl">Used Car Loan</h1>
            <p className="text-sm text-slate-600 mb-6">
              Finance your pre-owned car purchase with a guided document flow and quotation-based application
            </p>
            <div className="pt-2">
          ...
          {step === 7 && (
            <div className="space-y-6 py-8 text-center">
              ...
              <div>
                ...
                <p className="mt-2 text-sm text-gray-600">Your used car loan request has been submitted successfully.</p>
                {applicationId && (
