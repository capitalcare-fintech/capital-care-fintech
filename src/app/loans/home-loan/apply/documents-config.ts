export type HomeLoanApplicantType = "self-employed" | "salaried";
...
export const DOCUMENT_REQUIREMENTS: Record<HomeLoanApplicantType, DocumentItem[]> = {
  "self-employed": [
    ...
    { type: "gst_return_3b", label: "Last 1 Year GST Return 3B", isRequired: true, category: "Financial" },
    { type: "office_proof", label: "Office Address Proof", isRequired: true, category: "Business" },
    { type: "property_chain", label: "Property Papers with Complete Chain", isRequired: true, category: "Property" },
    { type: "agreement_to_sale", label: "Agreement to Sale", isRequired: true, category: "Property" },
...
export const getDocumentsByCategory = (applicantType: HomeLoanApplicantType) => {
