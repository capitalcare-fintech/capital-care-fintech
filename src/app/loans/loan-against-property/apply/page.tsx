...
import { DOCUMENT_REQUIREMENTS, getDocumentsByCategory, LapApplicantType } from "./documents-config";
...
export default function LoanAgainstPropertyApplyPage() {
  ...
  const handleApplicantSelect = (value: LapApplicantType) => {
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm md:p-8">
          <div className="mb-8 space-y-2">
            <h1 className="text-xl font-bold tracking-tight text-slate-900 md:text-2xl">Loan Against Property</h1>
            <p className="text-sm text-slate-600 mb-6">Secure funding journey with applicant-type-specific documentation</p>
            <div className="pt-2">
            ...
            <div className="space-y-5">
              ...
              <div className="grid gap-3 md:grid-cols-2">
                {[
                  ...
                  <button
                    key={opt.value}
                    onClick={() => handleApplicantSelect(opt.value as LapApplicantType)}
