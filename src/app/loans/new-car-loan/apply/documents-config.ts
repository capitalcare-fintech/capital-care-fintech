...
export const DOCUMENT_REQUIREMENTS: Record<CarLoanApplicantType, DocumentItem[]> = {
  ...
  salaried: [
    ...
    { type: "salary_slip_6m", label: "Last 6 Month Salary Slip", isRequired: true, category: "Income" },
    { type: "bank_statement_1y", label: "Last 1 Year Bank Statement", isRequired: true, category: "Income" },
